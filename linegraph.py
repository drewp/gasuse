...
class LineGraph(rend.Page):
    ...
    def trans(self, pt):
        return (25 + 835 * (pt[0] - self.xrange[0]) /
    ...
    def render_tics(self, ctx, data):
        ...
        while x <= self.xrange[1]:
            ...
            elts.append(Tag("text")(x=px, y=240+4, style="text-anchor:middle;dominant-baseline:text-before-edge;font-size:7pt;font-family:helvetica;")[Tag("tspan")["%.1f" % x]])
            x += 200 / (self.xrange[1] - self.xrange[0])
    ...
    docFactory = loaders.stan(Tag("svg")(xmlns="http://www.w3.org/2000/svg",
        ...
        Tag("defs")[Tag("marker")(id="Dot", viewBox="0 0 10 10",
                                  ...
                                  orient="auto")[
             Tag("circle")(fill="red", cx=5, cy=5, r=5)]],
        Tag("g")(transform="")[
